...
class Login extends CI_Controller
{
    ...
    public function __successful_login()
    {
    ...
    public function __invalid_login($username = "")
    {
    ...
    public function __invalid_login_warning($username = "")
    {
    ...
    public function __forbidden_login($username = "", $id = -1)
    {
